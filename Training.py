...
class Training():
    def __init__(self, validation=False, baseModel=[True, False, False], modifiedModel=[True, False, False, False],
    ...
    def Procedure(self):
        ...
        for self.lr in self.lrPair:
            ...
            self.model = Model(baseModel=self.baseModel, modifiedModel=self.modifiedModel)
            if self.cuda:
                self.model.cuda()
